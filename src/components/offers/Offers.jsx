  ...
  return (
   <div>
    ...
    <div className="flex justify-center  flex-wrap p-8 gap-4  "> 
        ...
        <div className="w-[45vw]  bg-secondary text-white p-4 rounded-lg h-[14rem] overflow-hidden custom800:w-full">
        ...
        <div  className="w-[35vw]  bg-secondary text-white p-4 rounded-lg h-[14rem] overflow-hidden x custom800:w-full  ">
        ...
        <div  className="w-[35vw]  bg-primary text-white p-4 rounded-lg h-[14rem] overflow-hidden   custom800:w-full sm:w-full ">
        ...
        <div  className="w-[45vw]  bg-primary text-white p-4 rounded-lg h-[14rem] overflow-hidden custom800:w-full">
