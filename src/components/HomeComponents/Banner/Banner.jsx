...
const Banner = ({data}) => {
  ...
  return (
    <div  className={`flex items-center bg-cover bg-center h-banner-height w-full bannerImage relative md:h-[30rem] sm:h-[33rem] `} style={{ backgroundImage: `url(${data.backgroundimg})` }}>
