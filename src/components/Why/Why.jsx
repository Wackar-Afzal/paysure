...
const Why = () => {
  return (
    <div className=" p-[4rem] flex gap-6 lg:flex-col ">
        ...
        <div className=" text-secondary  text-left w-[55%] lg:w-full">
            ...
            <div className="flex gap-2 mb-2"> <div className="rounded-full bg-primary px-[0.15rem] py-[0.08rem]">
            ...
            <div className="flex gap-2 mb-2 mb-2"><div className="rounded-full bg-primary px-[0.15rem] py-[0.08rem]">
                  <CheckIcon className="h-4 w-4 text-white" />
